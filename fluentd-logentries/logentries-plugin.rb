# Source taken from https://github.com/Woorank/fluent-plugin-logentries/blob/master/lib/fluent/plugin/out_logentries.rb
# see License here: https://github.com/Woorank/fluent-plugin-logentries/blob/master/LICENSE.txt
